---
title: 'Collapse'
description: 'Collapse displays a list of high-level options that can expand/collapse to reveal more or hide information.'
url: https://nextui.org/docs/components/collapse
---

# Collapse

Collapse displays a list of high-level options that can expand/collapse to reveal more or hide information.
