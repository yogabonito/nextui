// taken out of the amazing Stiches team work https://github.com/modulz/stitches/tree/canary/.task
...
let createNode = (...props) =>
  Object.assign(Object.create(prototype), ...props);
...
export let ExpressionStatement = (props) =>
  create('ExpressionStatement', props);
...
export let VariableDeclaration = (props) =>
  create('VariableDeclaration', props);
